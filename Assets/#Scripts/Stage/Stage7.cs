...
public class Stage7 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            BackGround.transform.position = new Vector3(BackGround.transform.position.x + 1.1f * Time.deltaTime, BackGround.transform.position.y, BackGround.transform.position.z);
